<div class="row" ng-controller="setupDetails">
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="box">
            <div class="box-title with-border">
                <p class="box-header text-center"><?php echo __( 'Configuration des détails', 'nexopos_advanced' );?></p>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6 col-xs-12 col-sm-6 col-lg-6">
                        <div class="form-group">
                            <div class="input-group">
                              ...
                              <input ng-model="options[ 'shop_name' ]"  type="text" class="form-control" placeholder="">
                            </div>
                            <p class="help-block"><?php echo _s( 'Nom de la boutique', 'nexopos' );?></p>
                        </div>
