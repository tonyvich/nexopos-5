...
class Media_Manager_Install extends Tendoo_Module
{
    ...
    **/
    ...
    {
        $this->db->query( 'CREATE TABLE IF NOT EXISTS `' . $this->db->dbprefix . $prefix . 'media_managerv2` (
    ...
    **/
    ...
    {
        $this->db->query('DROP TABLE IF EXISTS `'. $this->db->dbprefix . $prefix . 'media_managerv2`;');
    }
}
