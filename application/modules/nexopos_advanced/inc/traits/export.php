...
Trait export
{
    ...
    **/
    ...
    public function export_to_csv_post()
    {
        ...
        // Set properties
        $objPHPExcel->getProperties()->setCreator( $this->post( 'author' ) );
        $objPHPExcel->getProperties()->setLastModifiedBy( $this->post( 'author' ) );
        $objPHPExcel->getProperties()->setTitle( $this->post( 'name' ) );
        ...
        $file_location  =   UPLOADPATH . $file_name . '.csv';
        $objWriter      =   new PHPExcel_Writer_CSV($objPHPExcel);
        $objWriter->save( $file_location );
        $this->response([
            'file'  =>  site_url([ 'public', 'upload', $file_name . '.csv' ])
        ]);
    }
