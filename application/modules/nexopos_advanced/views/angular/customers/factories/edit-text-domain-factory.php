tendooApp.factory( 'customersEditTextDomain', function(){
    return  {
        title       :   '<?php echo __( 'Modifier un client', 'nexopos_advanced' );?>',
        return      :   '<?php echo __( 'Revenir vers la liste', 'nexopos_advanced' );?>',
        returnLink  :   '<?php echo site_url([ 'dashboard', 'nexopos', 'customers' ] );?>',
        itemTitle   :   '<?php echo __( 'Nom du client', 'nexopos_advanced' );?>',
        ...
        addNew      :   '<?php echo __( 'Modifier client', 'nexopos_advanced' );?>'
    }
});
