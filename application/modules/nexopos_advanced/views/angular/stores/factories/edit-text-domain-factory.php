tendooApp.factory( 'storesEditTextDomain', function(){
    return  {
        title   :   '<?php echo __( 'Modifier une boutique', 'nexopos_advanced' );?>',
        return  :   '<?php echo __( 'Revenir vers la liste', 'nexopos_advanced' );?>',
        returnLink  :   '<?php echo site_url([ 'dashboard', 'nexopos', 'stores' ] );?>',
        itemTitle  :   '<?php echo __( 'Modifier boutique', 'nexopos_advanced' );?>',
