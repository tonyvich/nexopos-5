tendooApp.factory( 'departmentsEditTextDomain', function(){
    return  {
        title   :   '<?php echo __( 'Modifier un rayon', 'nexopos_advanced' );?>',
        ...
        addNew  :   '<?php echo __( 'Nouveau Rayon', 'nexopos_advanced' );?>'
    }
});
