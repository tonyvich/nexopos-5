tendooApp.factory( 'couponsEditTextDomain', function(){
    return  {
        title       :   '<?php echo __( 'Modifier un coupon', 'nexopos_advanced' );?>',
        return      :   '<?php echo __( 'Revenir vers la liste', 'nexopos_advanced' );?>',
        returnLink  :   '<?php echo site_url([ 'dashboard', 'nexopos', 'coupons' ] );?>',
        itemTitle   :   '<?php echo __( 'Nom du coupon', 'nexopos_advanced' );?>',
