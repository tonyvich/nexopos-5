tendooApp.factory( 'providersTextDomain', function(){
    return  {
        title   :   '<?php echo __( 'Créer un Fournisseur', 'nexopos_advanced' );?>',
        return  :   '<?php echo __( 'Revenir vers la liste', 'nexopos_advanced' );?>',
        returnLink  :   '<?php echo site_url([ 'dashboard', 'nexopos', 'providers' ] );?>',
        itemTitle  :   '<?php echo __( 'Nouveau Fournisseur', 'nexopos_advanced' );?>',
        ...
        addNew  :   '<?php echo __( 'Nouveau Fournisseur', 'nexopos_advanced' );?>'
    }
});
