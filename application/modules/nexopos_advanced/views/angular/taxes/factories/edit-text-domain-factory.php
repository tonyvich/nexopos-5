tendooApp.factory( 'taxesEditTextDomain', function(){
    return  {
        title   :   '<?php echo __( 'Modifier une taxe', 'nexopos_advanced' );?>',
        return  :   '<?php echo __( 'Revenir vers la liste', 'nexopos_advanced' );?>',
        returnLink  :   '<?php echo site_url([ 'dashboard', 'nexopos', 'taxes' ] );?>',
        itemTitle  :   '<?php echo __( 'Modifier taxe', 'nexopos_advanced' );?>',
        ...
        addNew  :   '<?php echo __( 'Modifier taxe', 'nexopos_advanced' );?>'
    }
});
