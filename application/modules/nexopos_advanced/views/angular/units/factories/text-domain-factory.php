tendooApp.factory( 'unitsTextDomain', function(){
    return  {
        title   :   '<?php echo __( 'Créer une unité', 'nexopos_advanced' );?>',
        return  :   '<?php echo __( 'Revenir vers la liste', 'nexopos_advanced' );?>',
        returnLink  :   '<?php echo site_url([ 'dashboard', 'nexopos', 'units' ] );?>',
        itemTitle  :   '<?php echo __( 'nouvelle unité', 'nexopos_advanced' );?>',
        ...
        addNew  :   '<?php echo __( 'Nouvelle unité', 'nexopos_advanced' );?>'
    }
});
