        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="input-group">
                  ...
                  <select ng-model="options[ 'site_type' ]" type="text" class="form-control" placeholder="">
                    ...
                    <div class="text-center col-md-4 col-md-offset-4">
                        <div class="btn-group-justified">
                            <div class="btn-group" role="group">
                                <button ng-click="goto( '/setup/demo' )" type="button" style="margin-top:10px;" class="btn btn-primary"><?php echo __( 'Continuer', 'nexopos_advanced' );?></button>
                            </div>
                        </div>
                    </div>
                </div>
